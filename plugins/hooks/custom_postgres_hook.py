...
class CustomPostgresHook(BaseHook):
    ...
    def __init__(self, postgres_conn_id, **kargs):
    ...
    def get_conn(self):
        ...
        self.postgres_conn_id = psycopg2.connect(host=self.host, user=self.user, password=self.password, dbname=self.dbname)
